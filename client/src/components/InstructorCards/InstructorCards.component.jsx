...
const InstructorCards = () => {
  ...
  return (
    <div className="flex flex-col  justify-center">
      <div>
        <h1 className=" pb-10 text-center font-futurettex text-4xl font-bold">
          {' '}
      ...
      <div className="flex items-center justify-evenly">
        <div>
          ...
          >
            <div className="flex items-center justify-center">
              <div className="hover:boxa relative overflow-hidden rounded-2xl bg-none bg-cover md:h-[250px] md:w-[187.5px] 2xl:h-[499.5px] 2xl:w-[331.002px]">
                <div className="absoulte bg-white-500 h-full w-full">
                  <div className="flex h-full w-full items-center justify-center">
                    <img
                      className="w-72 rounded-xl border-4 border-cyan-400"
        ...
        <div>
          ...
          >
            <div className="flex items-center justify-center">
              <div className="hover:boxc relative overflow-hidden rounded-2xl bg-none bg-cover md:h-[250px] md:w-[187.5px] 2xl:h-[499.5px] 2xl:w-[331.002px]">
                <div className="absoulte bg-white-500 h-full w-full">
                  <div className="flex h-full w-full items-center justify-center">
                    <img
                      className="w-72 rounded-xl border-4 border-cyan-400"
        ...
        <div>
          ...
          >
            <div className="flex items-center justify-center">
              <div className="hover:boxd relative overflow-hidden rounded-2xl bg-none bg-cover md:h-[250px] md:w-[187.5px] 2xl:h-[499.5px] 2xl:w-[331.002px]">
                <div className="absoulte bg-white-500 h-full w-full">
                  <div className="flex h-full w-full items-center justify-center">
                    <img
